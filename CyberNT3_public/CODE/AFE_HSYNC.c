...
**         User handling procedure     : AFE_HSYNC_OnInterrupt
**
**         Used pin                    :
**             ----------------------------------------------------
**                Number (on package)  |    Name
**             ----------------------------------------------------
**                       49            |  GPIOD1_CS3B_CAN2_Rx
**             ----------------------------------------------------
**
**         Port name                   : GPIOD_Low
**
...
**     Contents  :
**         Enable - void AFE_HSYNC_Enable(void);
**
...
/*
** ===================================================================
**     Method      :  AFE_HSYNC_Enable (component ExtInt)
**
**     Description :
...
** ===================================================================
*/
void AFE_HSYNC_Enable(void)
{
  setReg(GPIO_D_IESR,AFE_HSYNC_PIN_MASK); /* Clear flag */
  setRegBits(GPIO_D_IENR,AFE_HSYNC_PIN_MASK); /* Enable interrupt "INT_GPIO_D" */
}
