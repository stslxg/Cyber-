...
static void SetRatio(void)
{
  setReg(PWMB_PWMVAL3,((getReg(PWMB_PWMCM)+1) * (dword)RatioStore) >> 16); /* Calculate new value according to the given ratio */
...
void DRV_LH_Init(void)
{
  ...
  setReg(PWMB_PWMVAL3,2000);           /* Store initial value to the duty-compare register */
