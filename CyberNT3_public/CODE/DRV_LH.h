...
**         Compare register            : PWMB_PWMVAL3 [61801]
...
**
**     Contents  :
**         SetRatio16 - byte DRV_LH_SetRatio16(word Ratio);
**
...
#define DRV_LH_PERIOD_VALUE 4000UL     /* Initial period value in ticks of the timer. It is available only if the bean is enabled in high speed mode. */
#define DRV_LH_PERIOD_VALUE_HIGH 4000UL /* Period value in ticks of the timer in high speed mode. It is available only if the bean is enabled in high speed mode. */

byte DRV_LH_SetRatio16(word Ratio);
/*
** ===================================================================
**     Method      :  DRV_LH_SetRatio16 (component PWM)
**
**     Description :
...
void DRV_LH_Init(void);
/*
** ===================================================================
**     Method      :  DRV_LH_Init (component PWM)
**
**     Description :
