...
void Inhr5_PutVal(bool Val)
{
  if (Val) {                           /* Is it one to be written? */
    setRegBits(GPIO_D_DR,Inhr5_PIN_MASK); /* Set bit on port */
  }
  else {                               /* Is it zero to be written? */
    clrRegBits(GPIO_D_DR,Inhr5_PIN_MASK); /* Clear bit on port */
  }
}
...
void Inhr5_SetDir(bool Dir)
{
  if (Dir) {                           /* Is given direction output? */
    setRegBits(GPIO_D_DDR,Inhr5_PIN_MASK); /* Set direction to output */
  }
  else {                               /* Is given direction input? */
    clrRegBits(GPIO_D_DDR,Inhr5_PIN_MASK); /* Set direction to input */
  }
}
