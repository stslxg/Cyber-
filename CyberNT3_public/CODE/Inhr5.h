...
**     Contents  :
**         SetDir - void Inhr5_SetDir(bool Dir);
...
#define Inhr5_PIN_MASK          ((word)4096) /* Pin mask */
#define Inhr5_PIN_MASK_SHIFTED  ((byte)16) /* Shifted pin mask by 8, if pin mask is greater than 128 */
...
** ===================================================================
*/
#define Inhr5_GetVal() ((bool)((getReg(GPIO_D_DR) >> 8) & Inhr5_PIN_MASK_SHIFTED))
...
/*
** ===================================================================
**     Method      :  Inhr5_SetDir (component BitIO)
**
**     Description :
...
** ===================================================================
*/
#define Inhr5_ClrVal() (clrRegBits(GPIO_D_DR,Inhr5_PIN_MASK))
...
** ===================================================================
*/
#define Inhr5_SetVal() (setRegBits(GPIO_D_DR,Inhr5_PIN_MASK))
...
** ===================================================================
*/
#define Inhr5_NegVal() (changeRegBits(GPIO_D_DR,Inhr5_PIN_MASK))
